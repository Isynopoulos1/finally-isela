...
**Verification depth scales with `asvs_level`** (see @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
