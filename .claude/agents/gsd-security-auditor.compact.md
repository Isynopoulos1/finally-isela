...
**Verification depth scales with `asvs_level`** (full definitions: @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/references/security-asvs-levels.md):
