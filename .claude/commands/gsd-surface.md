...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/.gsd-surface.json`
(sibling to `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/iselaalarcon/Documents/ia-curse/finally/.claude/skills`).
...
`/Users/iselaalarcon/Documents/ia-curse/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/.gsd-profile`
Skill dirs: `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/skills/gsd-*/`
Engine module: `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
