...
The keys live in `.claude/settings.json` (project) or `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/settings.json` (global) — **not** in `.planning/config.json`:
...
See @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
