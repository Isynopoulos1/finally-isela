...
Read and follow `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
