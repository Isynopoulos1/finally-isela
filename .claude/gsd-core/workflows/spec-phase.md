...
ones). Reference: @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/iselaalarcon/Documents/ia-curse/finally/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/iselaalarcon/Documents/ia-curse/finally/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/templates/spec.md.
