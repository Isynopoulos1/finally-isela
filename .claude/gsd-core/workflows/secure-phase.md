...
```
Agent(
  prompt="Read /Users/iselaalarcon/Documents/ia-curse/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/iselaalarcon/Documents/ia-curse/finally/.claude/gsd-core/templates/SECURITY.md`
